...
import type { IGame, IGameDetails } from "../../../@types/game.d.ts";
  ...
  useEffect(() => {
    const fetchMostChallengedGames = async () => {
      try {
        ...
        console.error(
          "Erreur API pour les jeux les plus challengés:",
      ...
      <main>
        ...
        <section className="hero min-h-[60vh] max-w-[80%]">
          <div className="hero-content text-center text-neutral-content">
            <div>
              <h1 className="mb-5 text-5xl font-bold pixel-font text-white">
                Relevez les défis
              </h1>
              <p className="mb-5 text-lg text-white">
                Rejoignez la communauté passionnée de gamers !
              </p>
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="stat bg-base-200 shadow-lg rounded-lg">
                ...
                <div className="stat-value text-secondary">{games.length}</div>
        ...
        <section className="section flex flex-col items-center max-w-[80%]">
          ...
          <div className="form-control mb-12 flex flex-row justify-center gap-2">
            <input
              ...
              className="input input-primary input-bordered w-50 md:w-100 lg:w-200"
            />
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold pixel-font mb-4">
          ...
          <div className="mt-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-base-content/70">
                Les jeux les plus joués de la communauté
              </p>
            </div>
