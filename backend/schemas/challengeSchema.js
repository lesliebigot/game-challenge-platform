...
export const createChallengeSchema = z.object({
  title: z
    .string()
    .min(1, "Le titre du challenge est trop court")
    .max(300, "Le titre du challenge est trop long"),
  description: z
    .string()
    .min(1, "La description du challenge est trop courte")
...
export const participateChallengeSchema = z.object({
  proof: z
    ...
    .refine((url) => url.startsWith("https://"), {
      message:
        "L'URL de la preuve doit être valide, l’URL doit commencer par https://",
    }),
});
